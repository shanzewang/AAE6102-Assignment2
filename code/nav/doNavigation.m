...
% function [obs, sat, nav, collect_fault] = doNavigation(obsData, allSettings, ephData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for currMeasNr = 1:nrOfEpochs
    ...
    if(bInit)
     ...
     % Calculate pseudoranges from transmission times and receiver time 
     ...
     if allSettings.sys.ls_type == 2
        ...
        % [obsData, satData, navData, collect_fault] = getNavSolution(obsData, satData, navData, allSettings, collect_fault);
     end
